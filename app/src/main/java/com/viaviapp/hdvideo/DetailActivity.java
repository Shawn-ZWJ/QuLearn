...
public class DetailActivity extends AppCompatActivity {
    ...
    int status_dislike = 0;//喜欢的状态 1 为踩了 0 为没有踩
        ...
        like.setOnClickListener( new View.OnClickListener() {
                                                  ...
                                                  public void onClick(View v) {
                                                      ...
                                                      if(status_like == 1){
                                                          ...
                                                          status_like=0;
                                                      }else if(status_like == 0 && status_dislike == 0){
                                                          ...
                                                          status_like=1;
                                                      }else if(status_like == 0 && status_dislike == 1){
        ...
        dislike.setOnClickListener( new View.OnClickListener() {
                                     ...
                                     public void onClick(View v) {
                                         ...
                                         if(status_dislike == 1){
                                             ...
                                             status_dislike=0;
                                         }else if(status_dislike == 0 && status_like == 0){
                                             ...
                                             status_dislike=1;
                                         }else if(status_dislike == 0 && status_like == 1){
