...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	private static final String KEY_VIDEO_VIEW = "videoview";
	private static final String KEY_VIDEO_PLAYID = "videoplayid";
	...
	public	void AddtoFavorite(Pojo pj)
	{
		...
		values.put(KEY_VIDEO_TYPE,pj.getVtype());
		values.put(KEY_VIDEO_VIEW,pj.getVview());
		values.put(KEY_VIDEO_PLAYID,pj.getVideoId());
	...
	public List<Pojo> getAllData()
	{
		...
		if (cursor.moveToFirst())
			do {
				...
				contact.setVideoName(cursor.getString(2));
				contact.setImageUrl(cursor.getString(3));
				contact.setDuration(cursor.getString(4));
				contact.setCategoryName(cursor.getString(5));
				contact.setVtype(cursor.getString(6));
				contact.setVview(cursor.getString(7));
				contact.setVideoId(cursor.getString(8));
